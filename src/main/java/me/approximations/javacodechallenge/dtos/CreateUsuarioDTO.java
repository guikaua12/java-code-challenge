...
public record CreateUsuarioDTO(@NotBlank(message="O nome" + ErrorEnum.NOT_NULL_MESSAGE) String name,
                               ...
                               @NotBlank(message="O cargo" + ErrorEnum.NOT_NULL_MESSAGE) String role,
                               Long departmentId) {
}
